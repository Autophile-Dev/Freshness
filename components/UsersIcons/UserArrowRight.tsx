...
const UserArrowRight = ({className} : IconProp) => {
  return (
    <svg className={`${className}`} viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M26.8 33.3332L29.9001 30.2332C29.9324 30.2035 29.9582 30.1674 29.9759 30.1273C29.9935 30.0871 30.0026 30.0437 30.0026 29.9998C30.0026 29.956 29.9935 29.9126 29.9759 29.8724C29.9582 29.8322 29.9324 29.7962 29.9001 29.7665L26.8 26.6665" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
  )
}
