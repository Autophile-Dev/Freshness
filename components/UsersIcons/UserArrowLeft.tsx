...
const UserArrowLeft = ({className} : IconProp) => {
  return (
    <svg className={`${className}`} viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M28.3332 26.6665L25.2332 29.7665C25.2009 29.7962 25.1751 29.8322 25.1574 29.8724C25.1397 29.9126 25.1306 29.956 25.1306 29.9998C25.1306 30.0437 25.1397 30.0871 25.1574 30.1273C25.1751 30.1674 25.2009 30.2035 25.2332 30.2332L28.3332 33.3332" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
  )
}
