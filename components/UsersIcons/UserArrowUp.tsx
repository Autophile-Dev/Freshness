...
const UserArrowUp = ({className} : IconProp) => {
  return (
    <svg className={`${className}`} viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M30.8334 31.3164L27.7334 28.2163C27.7037 28.184 27.6677 28.1582 27.6275 28.1405C27.5874 28.1229 27.544 28.1138 27.5001 28.1138C27.4562 28.1138 27.4128 28.1229 27.3726 28.1405C27.3325 28.1582 27.2964 28.184 27.2667 28.2163L24.1667 31.3164" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
    </svg> 
  )
}
