...
const generatePage = () => {
    return "flex flex-col items-center py-4 px-[80px] gap-[32px] w-full bg-white";
}
const frame105 = () => {
    return "flex flex-row items-start gap-[32px] w-full px-[80px]"
}
const generateBillingInfo = () => {
    return "flex flex-col items-center gap-[64px] w-full"
}
const frame107 = () => {
    return "flex flex-col items-center w-full"
}
const subFrame107 = () => {
    return "flex flex-col items-start gap-[32px] self-stretch w-full"
}
const frame106 = () => {
    return "flex flex-col items-start  self-stretch w-full"
}
const subFrame106 = () => {
    return "flex flex-row justify-between w-full"
}
const labelStyle = () => {
    return "text-22px font-[Poppins] text-textColor-black-text font-semibold"
}
const infoLabel = () => {
    return "font-[Open sans] text-xs text-textColor-input-text"
}
const formFrame = () => {
    return "flex flex-row items-start gap-[32px] self-center w-full"
}
const part1 = () => {
    return "flex flex-col items-start gap-[32px] w-full"
}
const part2 = () => {
    return "flex flex-col items-start gap-[32px] w-full"
}
const frame111 = () => {
    return "flex flex-col items-start bg-white w-full"
}
const subFrame111 = () =>{
    return "flex flex-col items-center gap-[32px] w-full"
}
const optionForm = () => {
    return "flex flex-col items-start w-full gap-[16px]"
}
const option = () => {
    return "box-border self-stretch flex flex-row items-center bg-backgrounds-C1/F-default-tag justify-between w-full border rounded-xl py-[16px] px-[16px]"
}
const option2 = () => {
    return "box-border self-stretch flex flex-row items-center bg-backgrounds-C1/F-default-tag justify-between w-full border rounded-xl py-[16px] px-[16px]"
}
...
const subFrame108 = () =>{
    return "flex flex-col items-center w-full gap-[32px] self-stretch"
}
const radioInput = () =>{
    return "w-6 h-6 cursor-pointer accent-textColor-text-Green"
}
const radioLabel = () =>{
    return "font-[Poppins] text-xs font-semibold text-textColor-black-text "
}
const additionalPrice = () => {
    return "font-[Poppins] text-xs font-semibold text-textColor-text-Green self-center"
}
const paymentOption = () => {
    return "flex flex-col items-start gap-[16px] w-full"
}
const paymentOptionPart1 = () => {
    return "box-border flex flex-col gap-[16px] items-center p-[16px] w-full border border-Input rounded-xl"
}
const paymentOptionPart2 = () => {
    return "box-border flex flex-col gap-[16px] items-center p-[16px] w-full"
}
const frame109 = () =>{
    return "flex flex-col items-start w-full"
}
const subFrame109 = () => {
    return "flex flex-col items-start self-stretch w-full gap-[32px]"
}
const frame110 = () => {
    return "flex flex-col items-start w-full"
}
const subFrame110 = () =>{
    return "flex flex-col items-start gap-[32px] self-stretch"
}
const checkForm = () => {
    return "flex flex-col items-start gap-[16px] self-stretch w-full"
}
const frame117 = () => {
    return "flex flex-col items-start gap-[8px] w-213px"
}
const subFrame117 = () => {
    return "flex flex-col items-start gap-[8px] w-full self-center"
}
const paragraph = () =>{
    return "w-full font-[Open sans] text-xs self-center text-textColor-input-text"
}
const checkout = () => {
  return (
        ...
        <div className='container mx-auto'>
            ...
            <div className={`${generatePage()}`}>
                ...
                <div className={`${frame105()}`}>
                    {/* Billing info */}
                    <div className={`${generateBillingInfo()}`}>
                        {/* Frame 107 */}
                        <div className={`${frame107()}`}>
                            {/* Sub Frame 107 */}
                            <div className={`${subFrame107()}`}>
                                {/* Frame 106 */}
                                <div className={`${frame106()}`}>
                                    {/* Label */}
                                    <label htmlFor="" className={`${labelStyle()}`}>Billing info</label>
                                    {/* Sub Frame 106 */}
                                    <div className={`${subFrame106()}`}>
                                        {/* info label */}
                                        <div className='text-left'>
                                            <label htmlFor="" className={`${infoLabel()}`}>Please enter your billing form</label>
                                        </div>
                                        <div className='text-right'>
                                            <label htmlFor="" className={`${infoLabel()}`}>Step 1 of 5</label>
                                        </div>
                                    </div>
                                </div>
                                {/* Form frame */}
                                <div className={`${formFrame()}`}>
                                    {/* part 1 */}
                                    <div className={`${part1()}`}>
                                        <Inputs label='Email address' className='w-auto' placeholder='Email address' />
                                        <Inputs label='Email address' className='w-auto' placeholder='Email address' />
                                        <Inputs label='Address' className='w-auto' placeholder='Address' />
                                        <Selects chevronHeight='16' chevronWidth='16' style="WithText" variant='Default' label='State/Country' placeholder='Choose State or Country' />
                                    </div>
                                    {/* Part 2 */}
                                    <div className={`${part2()}`}>
                                        <Inputs label='Last name' className='w-auto' placeholder='Last name' />
                                        <Inputs label='Phone number' className='w-auto' placeholder='Phone number' />
                                        <Inputs label='Town/City' className='w-auto' placeholder='Town or city' />
                                        <Inputs label='Zip/Postal code' className='w-auto' placeholder='Postal code or Zip' />
                                    </div>
                                </div>
                                <Checkboxes variant="WithText" status="Default" label='Ship to different address' />
                            </div>
                        </div>
                        {/* Frame 111 */}
                        <div className={`${frame111()}`}>
                            {/* Sub frame 111 */}
                            <div className={`${subFrame111()}`}>
                                {/* Frame 106 */}
                                <div className={`${frame106()}}`}>
                                    {/* Label */}
                                    <label htmlFor="" className={`${labelStyle()}`} >Billing Method</label>
                                    {/* Sub frame 106 */}
                                    <div className={`${subFrame106()}`}>
                                        {/* info label 1 */}
                                        <div className='text-left'>
                                            <label htmlFor="" className={`${infoLabel()}`}>Please select your payment method</label>
                                        </div>
                                        {/* info label 2 */}
                                        <div className='text-right'>
                                            <label htmlFor="" className={`${infoLabel()}`}>Step 2 of 5</label>
                                        </div>
                                    </div>
                                </div>
                                {/* Option form */}
                                <div className={`${optionForm()}`}>
                                    ...
                                    <div className={`${option()}`}>
                                        <div className='flex flex-row items-center  gap-[18px] relative'>
                                            ...
                                            <label htmlFor="" className={`${radioLabel()}`} >FedEx</label>
                                        </div>
                                        <div className='flex flex-row items-center w-168px gap-[4px] '>
                                            <span className={`${additionalPrice()}`} >+32 USD</span>
                                            <span className='font-[Poppins] font-semibold rounded-xl px-2 bg-backgrounds-C1/F-default-tag text-xs text-textColor-black-text'>Additional price</span>
                                        </div>
                                        <div className='flex flex-row items-center pl-9'>
                                    ...
                                    <div className={`${option2()}`}>
                                        <div className='flex flex-row items-center gap-[18px] relative'>
                                            <input type="radio" className={`${radioInput()}`} />
                                            <label htmlFor="" className={`${radioLabel()}`} >DHL</label>
                                        </div>
                                        <div className='flex flex-row items-center w-168px gap-[4px] '>
                                            <span className={`${additionalPrice()}`} >+15 USD</span>
                                            <span className='font-[Poppins] font-semibold rounded-xl px-2 bg-backgrounds-C1/F-default-tag text-xs text-textColor-black-text'>Additional price</span>
                                        </div>
                                        <div className='flex flex-row items-center'>
                                            <svg width="84" height="16" viewBox="0 0 93 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className={`${frame108()}`}>
                            {/* Sub Frame 108 */}
                            <div className={`${subFrame108()}`}>
                                {/* Frame 106 */}
                                <div className={`${frame106()}`}>
                                    {/* label */}
                                    <label htmlFor="" className={`${labelStyle()}`} >Payment Method</label>
                                    {/* Sub frame 106 */}
                                    <div className={`${subFrame106()}`}>
                                        {/* info label */}
                                        <div className='text-left'>
                                            <label htmlFor="" className={`${infoLabel()}`}>Please enter your payment method</label>
                                        </div>
                                        {/* info label */}
                                        <div className='text-right'>
                                            <label htmlFor="" className={`${infoLabel()}`}>Step 3 of 5</label>
                                        </div>
                                    </div>
                                </div>
                                {/* Payment option */}
                                <div className={`${paymentOption()}`}>
                                    {/* Payment option part 1 */}
                                    <div className={`${paymentOptionPart1()}`}>
                                        {/* Group 106 Sub Frame 106 */}
                                        <div className={`${subFrame106()}`}>
                                            {/* Radio + Label */}
                                            ...
                                            <svg width="94" height="20" viewBox="0 0 94 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <g clip-path="url(#clip0_19300_3225)">
                                                <g clip-path="url(#clip1_19300_3225)">
                                                ...
                                                <defs>
                                                <clipPath id="clip0_19300_3225">
                                                <rect width="94" height="20" fill="white"/>
                                                </clipPath>
                                                <clipPath id="clip1_19300_3225">
                                        ...
                                        {/* Group 106 pt-2 */}
                                        <div className='flex flex-col items-start gap-[32px] box-border w-full'>
                                            <Inputs label='Card number' className='w-full' placeholder='Card number' />
                                            {/* inner inputs */}
                                            <div className='flex flex-row box-border'>
                                                <Inputs label='Card holder' className='w-80' placeholder='Card holder' />
                                                <Inputs label='Expiration date' className='w-28' placeholder='DD/MM/YY' />
                                                <Inputs label='CVC' className='w-28' placeholder='CVC' />
                                            </div>
                                        </div>
                                    </div>
                                    {/* Payment option part 2 */}
                                    <div className={`${optionForm()}`}>
                                        {/* Option1 */}
                                        <div className={`${option()}`}>
                                            <div className='flex flex-row items-center  gap-[18px] relative'>
                        ...
                        <div className={`${frame109()}`}>
                            {/* Sub frame 109 */}
                            <div className={`${subFrame109()}`}>
                                {/* Frame 106 */}
                                <div className={`${frame106()}`}>
                                    {/* label */}
                                    <label htmlFor="" className={`${labelStyle()}`}>Additional informations</label>
                                    {/* Sub frame 106 */}
                                    <div className={`${subFrame106()}`}>
                                        {/* info label */}
                                        <div className='text-left'>
                                            <label htmlFor="" className={`${infoLabel()}`}>Need something else? We will make it for you!</label>
                                        </div>
                                        <div className='text-right'>
                                            <label htmlFor="" className={`${infoLabel()}`}>Step 4 of 5</label>
                                        </div>
                                    </div>
                                </div>
                                <TextArea  label='Order notes' placeholder='Need a specific delivery day? Sending a gift? Lets say ... '  />
                            </div>
                        </div>
                        {/* Frame 110 */}
                        <div className={`${frame110()}`}>
                            {/* Sub frame 110 */}
                            <div className={`${subFrame110()}`}>
                                {/* frame 106 */}
                                <div className={`${frame106()}`}>
                                    <label htmlFor="" className={`${labelStyle()}`} >Confirmation</label>
                                    {/* sub frame 106 */}
                                    <div className={`${subFrame106()}`}>
                                        <div className='text-left'>
                                            <label htmlFor="" className={`${infoLabel()}`}>We are getting to the end. Just few clicks and your order is ready!</label>
                                        </div>
                                        <div className='text-right'>
                                            <label htmlFor="" className={`${infoLabel()}`}>Step 5 of 5</label>
                                        </div>
                                    </div>
                                </div>
                                {/* Check form */}
                                <div className={`${checkForm()}`}>
                                    <Checkboxes variant="WithText" status="Default" label='I agree with sending an Marketing and newsletter emails. No spam, promised!' />
                                    <Checkboxes variant="WithText" status="Default" label='I agree with our terms and conditions and privacy policy.' />
                                </div>
                                {/* Button */}
                                <Buttons variant="Colored" size="Large" label='Complete order' type="Default" />
                                {/* Frame 117 */}
                                <div className={`${frame117()}`}>
                                    ...
                                    {/* Sub frame 117 */}
                                    <div className={`${subFrame117()}`}>
                                        <label htmlFor="" className="text-xs font-[Poppins] font-semibold text-textColor-black-text" >All your data are safe</label>
                                        <p className={`${paragraph()}`}>We are using the most advanced security to provide you the best experience ever.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    {/* Footer */}
    <Footers type="Simple" label='Copyright © 2020 Freshnesecom' variant="White" />
